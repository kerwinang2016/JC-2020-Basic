...
function service (request)
{
	...
	try
	{
		...
		{
			case 'GET':
				//nlapiLogExecution('debug',"request.getParameter('producttype')",request.getParameter('producttype'));
				var ptype = request.getParameter('producttype');
				var ptypearr = []

				var columns = [], items = [],filters=[];
				columns.push(new nlobjSearchColumn('internalid'));
				columns.push(new nlobjSearchColumn('custrecord_doc_product_type'));
				columns.push(new nlobjSearchColumn('custrecord_doc_mainoption_parent'));
				columns.push(new nlobjSearchColumn('custrecord_doc_main_option'));
				columns.push(new nlobjSearchColumn('custrecord_doc_conflict_type'));
				columns.push(new nlobjSearchColumn('custrecord_doc_conflict_op_parent'));
				columns.push(new nlobjSearchColumn('custrecord_doc_conflict_option'));
				columns.push(new nlobjSearchColumn('custrecord_doc_error_prompt'));
				...
				if(ptype){
					...
					ptypearr.push("@NONE@");
					filters.push(new nlobjSearchFilter('custrecord_doc_product_type',null,'anyof',ptypearr));
				}
				var search = nlapiCreateSearch('customrecord_design_option_conflicts',filters,columns);
