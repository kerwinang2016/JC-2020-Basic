...
function APMComponents() {
    Ext4.define('PSGP.APM.SPM.Component.BlueButton.Search', {
        ...
        handler: function() {
            ...
            PSGP.APM.SPM.dataStores.endToEndTimeParams.recordtype = recordtype; 
            PSGP.APM.SPM.dataStores.endToEndTimeParams.oper = oper;
            PSGP.APM.SPM.dataStores.endToEndTimeParams.email = email;
            PSGP.APM.SPM.dataStores.endToEndTimeParams.startDate = startDateObj;
            PSGP.APM.SPM.dataStores.endToEndTimeParams.endDate = endDateObj;
            PSGP.APM.SPM.dataStores.endToEndTimeParams.responseTimeOper = responseTimeOper;
            PSGP.APM.SPM.dataStores.endToEndTimeParams.responseTime1 = responseTime1;
            PSGP.APM.SPM.dataStores.endToEndTimeParams.responseTime2 = responseTime2;
...
//                   },
                         ...
                         items: [
                             {
                                 handler: function(grid, rowIndex, colIndex) {
                                     ...
                                     var dataParams = {
                                             compfil : PSGP.APM.SPM.dataStores.endToEndTimeParams.compfil,
    ...
    Ext4.define('PSGP.APM.SPM.Component.BlueButton.CompIdQuickSelector.Done', {
        ...
        handler: function() {
            ...
            PSGP.APM.SPM.dataStores.endToEndTimeParams.compfil = newCompFil;
    ...
    Ext4.define('PSGP.APM.SPM.Component.CompIdQuickSelector', {
        ...
        listeners: {
            beforerender: function () {
                Ext4.getCmp('psgp-apm-spm-quickselector-field-compid').setValue(PSGP.APM.SPM.dataStores.endToEndTimeParams.compfil);
            },
            hide: function () {
                Ext4.getCmp('psgp-apm-spm-quickselector-field-compid').setValue(PSGP.APM.SPM.dataStores.endToEndTimeParams.compfil);
            }
