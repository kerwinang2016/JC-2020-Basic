 ...
 * 21.00      14 Jan 2020     jmarimla         Customer debug changes
 *
 */
            ...
            recordTypeComboBox :  Ext4.create('Ext4.data.Store', {
                ...
                listeners : {
                    beforeload : function (store, operation, eOpts) {
                        ...
                        store.proxy.extraParams.compfil = PSGP.APM.SPM.dataStores.endToEndTimeParams.compfil;
                    },
...
//          }),
            ...
            endToEndTimeData : Ext4.create('Ext4.data.Store', {
                ...
                proxy : {
                    type : 'rest',
                    url : '/app/site/hosting/scriptlet.nl?script=customscript_apm_spm_sl_etetime&deploy=customdeploy_apm_spm_sl_etetime&testmode='+TEST_MODE,
                    timeout : 180000,
                    reader : {
                        type : 'json',
                        root : 'data',
            ...
            suitescriptDetailData : Ext4.create('Ext4.data.Store', {
                ...
                proxy : {
                    type : 'rest',
                    url : '/app/site/hosting/scriptlet.nl?script=customscript_apm_spm_sl_ssdetail&deploy=customdeploy_apm_spm_sl_ssdetail&testmode='+TEST_MODE,
                    timeout : 180000,
                    reader : {
                        type : 'json',
                        root : 'data',
            ...
            callEndToEndSummaryRESTlet: function () {
                ...
                Ext4.Ajax.request({
                   url: '/app/site/hosting/scriptlet.nl?script=customscript_apm_spm_sl_etesummary&deploy=customdeploy_apm_spm_sl_etesummary&testmode='+TEST_MODE,
                   timeout: 180000,
                   params: dataParams,
                   method: 'GET',
