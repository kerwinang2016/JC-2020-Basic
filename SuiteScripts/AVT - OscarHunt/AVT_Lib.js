 ...
 * 2.01			15 Sep 2020		Kim Morfe			Added Kerwin's code update from production script
 *
 */
...
var MyObj = function( request, response )
{
	...
	this.Form_Approval_POLineFabricUSA = function()
	{
				...
				)
		{
			...
			filter[ filter.length ] = new nlobjSearchFilter( 'entity', 'createdfrom', 'anyof', ['1002','914','84','118','758']);
			vendorval != null && vendorval !=''? filter[ filter.length ] = new nlobjSearchFilter( 'internalid', 'vendor', 'anyof', vendorval): null;
		}
		var searchid = 'customsearch_avt_so_to_approve_2_2';
	...
	this.Form_Approval_POLineFabricBilledUSA = function()
	{
				...
				)
		{
			...
			filter[ filter.length ] = new nlobjSearchFilter( 'entity', 'createdfrom', 'anyof', ['1002','914','84','118','758']);//Filter Dayan
			vendorval != null && vendorval !=''? filter[ filter.length ] = new nlobjSearchFilter( 'internalid', 'vendor', 'anyof', vendorval): null;
		}
		var searchid = 'customsearch_avt_so_to_approve_2_2_3';
	...
	this.Form_Approval_POLineCMT_UK = function()
	{
		...
		this.generateCMTSublist(sublist3,{'entity':'627','dateval':dateval,'cmtstatus':cmtstatus});
		
		this.generateCMTSublist(sublist4,{'entity':'685','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist5,{'entity':'716','dateval':dateval,'cmtstatus':cmtstatus});
		
		this.generateCMTSublist(sublist6,{'entity':'772','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist7,{'entity':'728','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist8,{'entity':'801','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist9,{'entity':'813','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist10,{'entity':'844','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist11,{'entity':'854','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist12,{'entity':'848','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist13,{'entity':'840','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist14,{'entity':'600','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist15,{'entity':'921','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist16,{'entity':'947','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist17,{'entity':'605','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist18,{'entity':'958','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist19,{'entity':'932','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist20,{'entity':'706','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist21,{'entity':'961','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist22,{'entity':'741','dateval':dateval,'cmtstatus':cmtstatus});
		this.response.writePage( form);
	...
	this.Form_Approval_POLineCMT_USA = function()
	{
		...
		var sublist5 = form.addSubList( 'custpage_subslist5', 'list', 'CMT Purchase Order Lines','custpage_sewt');
		if(dateval){
			fld_expdatesent.setDefaultValue(dateval);		
		}
		if(cmtstatus){
		...
		this.generateCMTSublist(sublist3,{'entity':'758','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist4,{'entity':'914','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist5,{'entity':'1002','dateval':dateval,'cmtstatus':cmtstatus});
		this.response.writePage( form);
	...
	this.Form_Approval_POLineCMT = function()
	{
		...
		this.generateCMTSublist(sublist4,{'entity':'708','dateval':dateval,'cmtstatus':cmtstatus});
		this.response.writePage( form);
	...
	this.Form_Approval_POLineCMTBilledUSA = function()
	{
		...
		this.generateCMTBilledSublist(sublist5,{'entity':'1002','dateval':dateval});
		this.response.writePage( form);
	...
	this.Form_Approval_POLineCMT_NZ = function()
	{
		...
		//For Bespoke Detroit and Birmingham 
		this.generateCMTSublist(sublist,{'entity':'646','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist1,{'entity':'726','dateval':dateval,'cmtstatus':cmtstatus});
		
		this.generateCMTSublist(sublist2,{'entity':'700','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist3,{'entity':'780','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist4,{'entity':'786','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist5,{'entity':'987','dateval':dateval,'cmtstatus':cmtstatus});
		this.response.writePage( form);
	...
	*/
	...
	this.Form_Approval_POLineCMT_Europe = function()
	{
		...
		searchCMTPurchaseOrders({'dateval':dateval,'cmtstatus':cmtstatus});

		
		this.generateCMTSublist(sublist,{'entity':'594','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist1,{'entity':'613','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist2,{'entity':'604','dateval':dateval,'cmtstatus':cmtstatus});
		
		this.generateCMTSublist(sublist3,{'entity':'617','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist4,{'entity':'624','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist5,{'entity':'639','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist6,{'entity':'640','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist7,{'entity':'644','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist8,{'entity':'667','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist9,{'entity':'673','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist10,{'entity':'677','dateval':dateval,'cmtstatus':cmtstatus});
		
		this.generateCMTSublist(sublist11,{'entity':'730','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist12,{'entity':'732','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist13,{'entity':'734','dateval':dateval,'cmtstatus':cmtstatus});
		
		this.generateCMTSublist(sublist14,{'entity':'654','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist15,{'entity':'776','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist16,{'entity':'750','dateval':dateval,'cmtstatus':cmtstatus});
		//this.generateCMTSublist(sublist17,{'entity':'828','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist18,{'entity':'761','dateval':dateval,'cmtstatus':cmtstatus});
		//this.generateCMTSublist(sublist19,{'entity':'830','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist20,{'entity':'837','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist21,{'entity':'815','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist22,{'entity':'842','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist23,{'entity':'835','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist24,{'entity':'852','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist25,{'entity':'885','dateval':dateval,'cmtstatus':cmtstatus});
		//this.generateCMTSublist(sublist26,{'entity':'857','dateval':dateval,'cmtstatus':cmtstatus});	//KM 15Sep2020 - Added Kerwin's update in production
		this.generateCMTSublist(sublist27,{'entity':'877','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist28,{'entity':'909','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist29,{'entity':'881','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist30,{'entity':'889','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist35,{'entity':'891','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist31,{'entity':'919','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist32,{'entity':'925','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist33,{'entity':'911','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist34,{'entity':'927','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist36,{'entity':'934','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist37,{'entity':'953','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist38,{'entity':'970','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist39,{'entity':'951','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist40,{'entity':'963','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist41,{'entity':'978','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist42,{'entity':'980','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist19,{'entity':'966','dateval':dateval,'cmtstatus':cmtstatus});
		this.generateCMTSublist(sublist43,{'entity':'993','dateval':dateval,'cmtstatus':cmtstatus});	//KM 15Sep2020 - Added Kerwin's update in production
		this.generateCMTSublist(sublist44,{'entity':'1010','dateval':dateval,'cmtstatus':cmtstatus});	//KM 15Sep2020 - Added Kerwin's update in production
		this.response.writePage( form);
...
function searchCMTPurchaseOrders(parameters){
	try {
