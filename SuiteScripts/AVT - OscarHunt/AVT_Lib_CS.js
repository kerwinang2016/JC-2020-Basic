...
var SavePOCMT = function( arg)
{
	...
	data = getCMTLines('custpage_subslist15', data, arg);
	data = getCMTLines('custpage_subslist16', data, arg);
	data = getCMTLines('custpage_subslist17', data, arg);
	data = getCMTLines('custpage_subslist18', data, arg);
	data = getCMTLines('custpage_subslist19', data, arg);
	data = getCMTLines('custpage_subslist20', data, arg);
	data = getCMTLines('custpage_subslist21', data, arg);
	data = getCMTLines('custpage_subslist22', data, arg);
	data = getCMTLines('custpage_subslist23', data, arg);
	data = getCMTLines('custpage_subslist24', data, arg);
	data = getCMTLines('custpage_subslist25', data, arg);
	data = getCMTLines('custpage_subslist26', data, arg);
	data = getCMTLines('custpage_subslist27', data, arg);
	data = getCMTLines('custpage_subslist28', data, arg);
	data = getCMTLines('custpage_subslist29', data, arg);
	data = getCMTLines('custpage_subslist30', data, arg);
	data = getCMTLines('custpage_subslist31', data, arg);
	data = getCMTLines('custpage_subslist32', data, arg);
	data = getCMTLines('custpage_subslist33', data, arg);
	data = getCMTLines('custpage_subslist34', data, arg);
	data = getCMTLines('custpage_subslist35', data, arg);
	data = getCMTLines('custpage_subslist36', data, arg);
	data = getCMTLines('custpage_subslist37', data, arg);
	data = getCMTLines('custpage_subslist38', data, arg);
	data = getCMTLines('custpage_subslist39', data, arg);
	data = getCMTLines('custpage_subslist40', data, arg);
