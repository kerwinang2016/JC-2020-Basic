...
function MyAccountPOST(request,response){
	...
	var returnObj = "";
	switch(action){
		case "getcmtandstockedfabric": returnObj = getCMTandStockedFabric(user); break;
		case "getsurchargesformakeandtrim": returnObj = getSurchagesForMakeAndTrim(user); break;
		case "getcutlengthfabricvendors": returnObj = getCutLengthFabricVendors(user); break;
		case "getfabriccmtdescriptions": returnObj = getFabricCMTDescriptions(request.getParameter('user'),request.getParameter('item'),request.getParameter('currency'),request.getParameter('pricelevel')); break;
		case "getitemfields": returnObj = getItemFields(request.getParameter('item'),request.getParameter('currency'),request.getParameter('pricelevel')); break;
		case "getserviceitemfields": returnObj = nlapiLookupField('noninventoryitem', request.getParameter('item'), ['custitem_jerome_cmt_basic_price']); break;
		case "getcustomerdetails": returnObj = getCustomerDetails(request.getParameter('user')); break;

		case "getprice": returnObj = getPrice(request.getParameter('item'),request.getParameter('pricelevel'),request.getParameter('currency'),request.getParameter('customerpricelevel')); break;
		case "getparent": returnObj = getParent(user);break;
		case "getchildren": returnObj = getChildren(user);break;
		case "getorders": returnObj = getOrders(request);break;
		case "getordersV2": returnObj = getOrdersV2(request);break;
		case "getorder":
		if(!request.getParameter('user')) returnObj = {};
		else returnObj = getOrder(request.getParameter('id'),request.getParameter('user')); break;
		case "getorderV2":
		if(!request.getParameter('user')) returnObj = {};
		else returnObj = getOrderV2(request.getParameter('id'),request.getParameter('user')); break;

		case "createproductlist": returnObj = createProductList(request.getParameter('user'),JSON.parse(request.getBody())); break;
		case "getstocklist": returnObj = getStockList(); break;
		case "getclientname": returnObj = getClientName(request.getParameter('tailorid'),request.getParameter('clientid')); break;
...
function getCMTandStockedFabric(user){
	var returnObj = {}, dayangPrices = [], shippingcharges = [];
	...
	var allCMT = [];
	var productTypes = {
		"3-Piece-Suit":{id:"9904", name:"threepc"},
		"2-Piece-Suit":{id:"9903",name:"twopc"},
		"Jacket":{id:"9898", name:"jacket"},
		"Trouser":{id:"9899", name:"trouser"},
		"Waistcoat":{id:"9900", name:"waistcoat"},
		"Shirt":{id:"9902", name:"shirt"},
		"Overcoat":{id:"9901", name:"overcoat"},
		"Trenchcoat":{id:"292321", name:"trenchcoat"},
		"L-3PC-Suit":{id:"292332", name:"ladiesthreepc"},
		"L-2PC-Pants":{id:"292331", name:"twopcpants"},
		"L-2PC-Skirt":{id:"292330", name:"twopcskirt"},
		"Ladies-Jacket":{id:"292328", name:"ladiesjacket"},
		"Ladies-Pants":{id:"292327", name:"ladiespants"},
		"Ladies-Skirt":{id:"292326", name:"ladiesskirt"},
		"Short-Sleeves-Shirt":{id:"292329",name:"shortsleeve"},
		"Shorts":{id:"296338",name:"shorts"},
		"Morning-Coat":{id:"296339",name:"morningcoat"},
		"Safari-Jacket":{id:"296340",name:"safarijacket"},
		"Shirt-Jacket":{id:"296341",name:"shirtjacket"},
		"Camp-Shirt":{id:"296342",name:"campshirt"}
		};
	...
	if(user){
		...
		if(customerFields.custentity_surcharges_make_trims_do){
			...
			if(results && results.length>0){
				returnObj = {filename:results[0].getValue('name'), url:results[0].getValue('url'), lastupdated:results[0].getValue('modified')};
			}
		}else{
...
function getCutLengthFabricVendors(user){
	...
	if(user){
		...
		var vendors = [
			{id:689, name:'AC Shirt',field:'custentity_acshirt_pricelevel'},
			{id:88, name:'Ariston',field:'custentity_ariston_pricelevel'},
			{id:596,name:'Carnet',field:'custentity_carnet_pricelevel'},
			{id:15,name:'Dormeuil',field:'custentity_dormeuil_pricelevel'},
			{id:672,name:'Drago',field:'custentity_drago_pricelevel'},
			{id:79,name:'Dugdage Bros',field:'custentity_dugdale_pricelevel'},
			{id:675,name:'Filarte',field:'custentity_filarte_pricelevel'},
			{id:54,name:'Harrisons',field:'custentity_harrisons_pricelevel'},
			{id:59,name:'Loro Piana',field:'custentity_loropiana_pricelevel'},
			{id:92,name:'Thomas Mason',field:'custentity_thomasmason_pricelevel'}
		];
		var clfields = {
		...
		for(var i=0;i<vendors.length;i++){
			...
			if(customVendorPriceLevel){
				...
				if(vendorFileId){
					...
					if(results && results.length>0){
						returnObj.push({name: vendors[i].name, filename:results[0].getValue('name'), url:results[0].getValue('url'), lastupdated:results[0].getValue('modified')});
					}
				}else{
...
function getMarginReport(tailor,page){
	...
	columns = [
		...
		, new nlobjSearchColumn("custitem_jerome_cmt_serviceitem", 'item')
		, new nlobjSearchColumn('trandate')
		, new nlobjSearchColumn('tranid')
		, new nlobjSearchColumn('status')
		, new nlobjSearchColumn('fxamount')
		, new nlobjSearchColumn('custcol_tailor_cust_pricing')
		, new nlobjSearchColumn('custcol_sale_item_type')
		, new nlobjSearchColumn('custcol_producttype')
		, new nlobjSearchColumn('custitem_jerome_cmt_serviceitem','item')
	];
	var search = nlapiCreateSearch('salesorder', filters, columns).runSearch();
	...
	if(results){
		for(var i=0;i< results.length;i++){
			var found = _.find(returnObj,function(o){ return o.soid == results[i].getValue('custcol_so_id');});
			if(found){
				...
				var shipping = 0, duties = 0, margin = 0, marginpercent = 0, totalcogs = 0;
				var found = _.find(shippingcharges,function(d){return d.tailor == tailor && d.producttype == results[i].getValue('custcol_producttype')});
				if(found){
					shipping = found.rate?parseFloat(found.rate):0;
				}
				var found = _.find(duetiescosts,function(d){return d.producttype == results[i].getValue('custcol_producttype')});
				if(found){
...
function getPrice(item,pricelevel,currency, customerpricelevel){
	...
	if(results){
		returnObj = {'price': results[0].getValue('unitprice','pricing')};
	}else{
		returnObj = {'price':0};
	}
...
function createPayment(user,data){
	'use strict';
	var customer_payment = nlapiCreateRecord('customerpayment',{recordmode: 'dynamic',entity:user});
...
function getOrdersV2(request){
	...
	, filters = [
		...
		new nlobjSearchFilter('custitem_jerome_cmt_serviceitem', 'item', 'is', 'F')
		, new nlobjSearchFilter('isspecialorderitem', 'item', 'is', 'T')
	]
	, columns = [
		new nlobjSearchColumn('internalid').setSort(true)
	...
	result.records = _.map(result.records || [], function (record) {
		...
		return {
			...
			, currency: { internalid: record.getValue('currency'), name: record.getText('currency') }
...
function createResultV2(placed_order) {
	...
	return {
		...
		, createdfrom: {internalid: "", name: "", recordtype: ""}
		, status: {internalid: placed_order.getFieldValue('statusRef'), name: placed_order.getFieldValue('status')}
		, selected_currency: {internalid: placed_order.getFieldValue('currency'), symbol: currency[placed_order.getFieldValue('currencysymbol')], code: placed_order.getFieldValue('currencysymbol'), name: placed_order.getFieldValue('currencyname'), currencyname: placed_order.getFieldValue('currencyname'),isdefault: "T", symbolplacement: 1}
		...
		if (placed_order.getLineItemValue('item', 'itemtype', i) === 'Discount' && placed_order.getLineItemValue('item', 'discline', i)) {
			...
			if (placed_order.getLineItemValue('item', 'custcol_flag_comment', i)) {
				lineOption.push({
					...
					, label: 'Flag Comment'
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_flag_comment', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_flag', i)) {
				lineOption.push({
					...
					, label: 'Flag'
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_flag', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_designoption_message', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_designoption_message', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_designoptions_jacket', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_designoptions_jacket', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_designoptions_overcoat', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_designoptions_overcoat', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_designoptions_shirt', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_designoptions_shirt', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_designoptions_trouser', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_designoptions_trouser', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_designoptions_waistcoat', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_designoptions_waistcoat', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_designoptions_trenchcoat', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_designoptions_trenchcoat', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_designoptions_ssshirt', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_designoptions_ssshirt', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_designoptions_ladiesskirt', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_designoptions_ladiesskirt', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_designoptions_ladiespants', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_designoptions_ladiespants', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_designoptions_ladiesjacket', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_designoptions_ladiesjacket', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_designoptions_safari_jacket', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_designoptions_safari_jacket', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_designoptions_camp_shirt', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_designoptions_camp_shirt', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_designoptions_shirt_jacket', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_designoptions_shirt_jacket', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_designoptions_morning_coat', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_designoptions_morning_coat', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_designoptions_shorts', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_designoptions_shorts', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_fitprofile_summary', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fitprofile_summary', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_fitprofile_message', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fitprofile_message', i)}
					, ismandatory: false
				});
			}
			...
			if (placed_order.getLineItemValue('item', 'custcol_tailor_cust_pricing', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_tailor_cust_pricing', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_tailor_client', i)) {
				...
				lineOption.push({
					...
					, label: 'Client Name'
					, value: {internalid: placed_order.getFieldValue('custbody_customer_name')}//getClientName(clientId)
					, ismandatory: false
				});
				}
			}
			if (placed_order.getLineItemValue('item', 'custcol_itm_category_url', i)) {
				lineOption.push({
					...
					, label: 'Category URL'
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_itm_category_url', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_fabric_quantity', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fabric_quantity', i)}
					, ismandatory: false
				});
			}
			...
			if (placed_order.getLineItemValue('item', 'custcol_avt_date_needed', i)) {
				lineOption.push({
					...
					, label: 'Date Needed'
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_avt_date_needed', i) || '1/1/1900'}
					, ismandatory: false
				});
			}
			...
			if (placed_order.getLineItemValue('item', 'custcol_avt_hold_fabric', i)) {
				lineOption.push({
					...
					, label: 'Hold Fabric'
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_avt_hold_fabric', i) || 'F'}
					, ismandatory: false
				});
			}
			...
			if (placed_order.getLineItemValue('item', 'custcol_avt_hold_production', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_avt_hold_production', i) || 'F'}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_custom_fabric_details', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_custom_fabric_details', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_producttype', i)) {
				lineOption.push({
					...
					, label: 'Product Type'
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_producttype', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_vendorpicked', i)) {
				lineOption.push({
					...
					, label: 'CMT Vendor'
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_vendorpicked', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_avt_wbs_copy_key', i)) {
				lineOption.push({
					...
					, label: 'Copy Key'
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_avt_wbs_copy_key', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_fitprofile_shirt', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fitprofile_shirt', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_fitprofile_jacket', i)) {
				lineOption.push({
					...
					, label: 'Fit Profile - Shirt'
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fitprofile_jacket', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_fitprofile_ladiesjacket', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fitprofile_ladiesjacket', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_fitprofile_waistcoat', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fitprofile_waistcoat', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_fitprofile_ladiesskirt', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fitprofile_ladiesskirt', i)}
					, ismandatory: false
				});
            }
            if (placed_order.getLineItemValue('item', 'custcol_fitprofile_ladiespants', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fitprofile_ladiespants', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_fitprofile_overcoat', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fitprofile_overcoat', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_fitprofile_ssshirt', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fitprofile_ssshirt', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_fitprofile_trenchcoat', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fitprofile_trenchcoat', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_fitprofile_trouser', i)) {
				lineOption.push({
					...
					, label: 'Fit Profile - Trenchcoat'
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fitprofile_trouser', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_fitprofile_shorts', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fitprofile_shorts', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_fitprofile_morning_coat', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fitprofile_morning_coat', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_fitprofile_shirt_jacket', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fitprofile_shirt_jacket', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_fitprofile_camp_shirt', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fitprofile_camp_shirt', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_fitprofile_safari_jacket', i)) {
				lineOption.push({
					...
					, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fitprofile_safari_jacket', i)}
					, ismandatory: false
				});
			}
			if (placed_order.getLineItemValue('item', 'custcol_custom_fabric_details', i)) {
			...
			lineOption.push({
				...
				, value: {internalid: placed_order.getLineItemValue('item', 'custcol_othervendorname', i)}
				, ismandatory: false
			});
			lineOption.push({
				...
				, label: 'COGS'
				, value: {internalid: placed_order.getLineItemValue('item', 'custcol_site_cogs', i)?escape(placed_order.getLineItemValue('item', 'custcol_site_cogs', i)):""}
				, ismandatory: false
			});
			lineOption.push({
				...
				, label: 'Extra'
				, value: {internalid: placed_order.getLineItemValue('item', 'custcol_fabric_extra', i)?escape(placed_order.getLineItemValue('item', 'custcol_fabric_extra', i)):""}
				, ismandatory: false
			});
...
function getShippingCharges(user){
	var shippingcharges = [], filter = [], cols = [];
